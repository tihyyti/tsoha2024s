...
image_create_bp = Blueprint('image_create', __name__)

@image_create_bp.route('/image_create/<int:image_id>', methods=['GET', 'POST'])
def image_create(image_id):
    conn = None
    cursor = None
    try:
    ...
    return render_template('image_create.html', image=image)
